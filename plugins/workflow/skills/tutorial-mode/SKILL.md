...
- Point at the tools. For each step, name which components, composables, utilities, or APIs to reach for, and why. Let the user wire it up. (Follow the solution priority in `nuxt-conventions:frontend`.)
